...
//  SearchKitDemo
//
//  Created by Tommy Ludwig on 01.11.23.
//
...
@objc public class SearchIndex: NSObject {
...
extension SearchIndex {
    ...
    public class ProgressiveSearch: NSObject {
        ...
        fileprivate init(_ index: SearchIndex, query: String, options: SKSearchOptions) {
            self.query = query
            self.index = index
